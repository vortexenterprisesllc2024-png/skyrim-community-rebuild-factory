...
The menu is `AdventureXPMCM` on quest `AdventureXPMCMQuest`. MCM script `GetVersion()` is **15**.

| Page | Options |
| --- | --- |
| **General** | Award Adventure XP; Show Messages; Global XP (reserved, unused for awards); Playstyle Pack |
